...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-5">
        <div class="container align-items-center">
            <a class="navbar-brand" href="/"><img src="{{asset('images/logo.png')}}" alt="" style="height: 30px; vertical-align: sub"> <span class="ms-2 mt-3">E-Clinics</span></a>
...
<footer class="bg-primary fixed-bottom text-center text-light">
    <div class="container">
